...
(tt/expect-with-temp [Activity [activity1 {:topic     "install"
                                           :details   {}
                                           :timestamp (u/->Timestamp #inst "2015-09-09T12:13:14.888Z")}]
                      Activity [activity2 {:topic     "dashboard-create"
                                           ...
                                           :details   {:description  "Because I can!"
                                                       :name         "Bwahahaha"}
                                           :timestamp (u/->Timestamp #inst "2015-09-10T18:53:01.632Z")}]
                      Activity [activity3 {:topic     "user-joined"
                                           :user_id   (user->id :rasta)
                                           :model     "user"
                                           :details   {}
                                           :timestamp (u/->Timestamp #inst "2015-09-10T05:33:43.641Z")}]]
